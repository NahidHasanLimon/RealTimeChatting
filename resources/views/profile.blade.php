   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p> removing this proeprty from saved listings does not auto remove the notes.</p>
       </div>
     </div>
   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p>Personal Notes on the Property (can be edited and saved automatically by clicking in and clicking out of text area) - these .</p>
       </div>
     </div>
     <footer class='card-footer'>
       <a class='card-footer-item'>Compare</a>
   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p>Pse, removing this proeprty from saved listings does not auto remove the notes.</p>
       </div>
     </div>
     <footer class='card-footer'>
       <a class='card-footer-item'>Compare</a>
   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p>Personal Notes on the Property (can be edited and saved automatically by click from saved listings does not auto remove the notes.</p>
       </div>
     </div>
     <footer class='card-footer'>
       <a class='card-footer-item'>Compare</a>
   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p>Personal Notes on the Property (can be edited and saved automatically by clicking in and clicking out of text area) - these  from saved listings does not auto remove the notes.</p>
       </div>
     </div>
     <footer class='card-footer'>
       <a class='card-footer-item'>Compare</a>
   ...
   <div class='card'>
     ...
     <div class='card-content'>
       <div class='content'>
         ...
         <p>Personal Notes on the Property (can be edited and saved  automatically create a saved listing. Likewise, removing this proeprty from saved listings does not auto remove the notes.</p>
       </div>
     </div>
     <footer class='card-footer'>
       <a class='card-footer-item'>Compare</a>
